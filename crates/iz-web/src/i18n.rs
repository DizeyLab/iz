...
pub fn t(lang: Lang, key: Key) -> &'static str {
    ...
    match (key, lang) {
        ...
        (SheetWindowEmpty, En) => "This window is past the sheet's cells — step back.",
        (SheetWindowEmpty, Tr) => "Bu pencere sayfanın hücrelerinin ötesinde — geri dön.",
        ...
        (ConnectionIssuer, En) => "Issuer",
        (ConnectionIssuer, Tr) => "Sağlayıcı",
        (ConnectionClientId, En) => "Client ID",
        (ConnectionClientId, Tr) => "İstemci kimliği",
        (ConnectionStream, En) => "Directory stream",
        (ConnectionStream, Tr) => "Dizin akışı",
        (ConnectionConnected, En) => "Connected",
        (ConnectionConnected, Tr) => "Bağlı",
        (ConnectionReconnecting, En) => "Reconnecting",
        (ConnectionReconnecting, Tr) => "Yeniden bağlanıyor",
        (ConnectionLastEvent, En) => "Last roster event",
        (ConnectionLastEvent, Tr) => "Son dizin olayı",
        (ConnectionLastPass, En) => "Last full pass",
        (ConnectionLastPass, Tr) => "Son tam geçiş",
        (ConnectionNever, En) => "never",
        (ConnectionNever, Tr) => "hiç",
        (StorageTitle, En) => "Storage",
        (StorageTitle, Tr) => "Depolama",
        (StorageService, En) => "Service",
        (StorageService, Tr) => "Hizmet",
        (StorageMode, En) => "Mode",
        (StorageMode, Tr) => "Mod",
        (StorageModeLocal, En) => "Local disk",
        (StorageModeLocal, Tr) => "Yerel disk",
        (StorageModeIn, En) => "Files (in)",
        (StorageModeIn, Tr) => "Dosyalar (in)",
        (StorageConnection, En) => "Connection",
        (StorageConnection, Tr) => "Bağlantı",
        (StorageUnreachable, En) => "Unreachable",
        (StorageUnreachable, Tr) => "Erişilemiyor",
        (StorageLimit, En) => "Limit",
        (StorageLimit, Tr) => "Limit",
        (StorageMigration, En) => "Migration",
        (StorageMigration, Tr) => "Aktarım",
        (StorageLastProblem, En) => "Last problem",
        (StorageLastProblem, Tr) => "Son sorun",
        (StorageAbsent, En) => "Not in the family",
        (StorageAbsent, Tr) => "Ailede değil",
        (EmailLabel, En) => "Email",
        ...
        (AttachmentLimitLabel, Tr) => "Ek limiti (MB)",
        (AllowedFileTypesLabel, En) => "Allowed file types",
        (AllowedFileTypesLabel, Tr) => "İzin verilen dosya türleri",
        (Members, En) => "Members",
        (Members, Tr) => "Üyeler",
        (Message, En) => "Message",
        (Message, Tr) => "Mesaj",
        ...
        (BodyLabel, En) => "Body",
        (BodyLabel, Tr) => "İçerik",
        (SubjectPlaceholder, En) => "Task completed",
        (SubjectPlaceholder, Tr) => "Görev tamamlandı",
